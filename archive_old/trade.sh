...
do
  # tap trade button
  adb shell input swipe 540 1180 540 1500 500
  sleep 1
  adb shell input tap 934 1634
  sleep 1
  adb shell input swipe 540 1660 540 500 750
  sleep 1
  adb shell input tap 934 2275
  sleep 5
  ...
  # equalize screens
  adb shell input swipe 540 700 540 1000 500
  sleep 1
